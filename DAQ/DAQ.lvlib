...
<Library LVVersion="17008000">
	...
	<Item Name="操作者消息" Type="Folder">
		<Item Name="Set AO Chan消息.lvclass" Type="LVClass" URL="../DAQ Messages/Set AO Chan消息/Set AO Chan消息.lvclass"/>
		<Item Name="Write AO Voltage消息.lvclass" Type="LVClass" URL="../DAQ Messages/Write AO Voltage消息/Write AO Voltage消息.lvclass"/>
	</Item>
